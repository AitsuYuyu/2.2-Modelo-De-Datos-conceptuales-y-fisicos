...
CREATE TABLE `inventario`(
    ...
    `pro_limits` VARCHAR(255) NOT NULL,
    `pro_unlimits` VARCHAR(255) NOT NULL
);
...
ALTER TABLE
    `cliente equipos` ADD CONSTRAINT `cliente equipos_jugadores_foreign` FOREIGN KEY(`jugadores`) REFERENCES `promociones`(`descuentoXJugador`);
ALTER TABLE
...
ALTER TABLE
    `inventario` ADD CONSTRAINT `inventario_pro_unlimits_foreign` FOREIGN KEY(`pro_unlimits`) REFERENCES `promociones`(`promosion_id`);